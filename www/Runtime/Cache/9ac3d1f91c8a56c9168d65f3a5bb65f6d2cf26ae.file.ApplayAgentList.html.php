<?php /* Smarty version Smarty-3.1.6, created on 2018-02-01 15:03:42
         compiled from "E:/wamp/www/Admin/View\Agent\ApplayAgentList.html" */ ?>
<?php /*%%SmartyHeaderCode:204145a6af22fcb6da8-96433923%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9ac3d1f91c8a56c9168d65f3a5bb65f6d2cf26ae' => 
    array (
      0 => 'E:/wamp/www/Admin/View\\Agent\\ApplayAgentList.html',
      1 => 1517468589,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '204145a6af22fcb6da8-96433923',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5a6af2300a50e',
  'variables' => 
  array (
    'adminname' => 0,
    'infos' => 0,
...
<?php if ($_valid && !is_callable('content_5a6af2300a50e')) {function content_5a6af2300a50e($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'E:\\wamp\\www\\ThinkPHP\\Library\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
...
/Agent/getApplayAgentInfos/?state=0" >待审核用户</a>
            <a  href="<?php echo @__MODULE__;?>
/Agent/getApplayAgentInfos/?state=1" >已审核用户</a>
        </div>
        <div class="tables">
...
?>
		...
		<tr>
		   ...
		   <td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['info']->value['applytime'],"%Y-%m-%d %H:%M:%S");?>
</td>
		   
		   <?php if ($_smarty_tpl->tpl_vars['info']->value['state']=='0'){?>
		   <td><a class="applycheck" href='#'>进入审核</a></td>
		   <input type='hidden' text='' class="hide_id" value="<?php echo $_smarty_tpl->tpl_vars['info']->value['id'];?>
">
		   <?php }?>
		   <?php if ($_smarty_tpl->tpl_vars['info']->value['pass']=='1'){?>
		   <td ><font color='green'>申请成功</font></td>
		   <?php }?>
		   <?php if ($_smarty_tpl->tpl_vars['info']->value['pass']=='2'){?>
...
/Agent/check",{"uid":uid,"result":1,"message":message},function(data){
			...
			btn1.click(function(){
			    ...
			    $.post("<?php echo @__MODULE__;?>
/Agent/check",{"uid":uid,"result":2,"message":message},function(data){
