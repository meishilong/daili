    ...
    <div class="main">
        ...
        <form action="/index.php/admin/index/login" method='POST'>
            ...
            <div class="form_list">
                ...
                <div class="yzm_pic" onclick="getPic();"><img  id="codePic" src="/index.php/admin/index/Verify" ></div>
...
<script src="http://localhost/Public/js/index.js"></script>
<script>
...
$(function(){
	...
	$(".form_btn").click(function(){
		...
		if(username_input!==""&&password_input!==""&&yzm_input!==""){
		    $.post("/index.php/admin/index/checklogin",{"username":username_input,"password":password_input
...
<script type="text/javascript">  
     //刷新验证码
     function getPic(){   
           $("#codePic").attr("src","/index.php/admin/index/Verify?flag="+Math.random());   
      };  
</script> 
</html><?php }} ?>